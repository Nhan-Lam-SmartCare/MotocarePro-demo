-- Fix sale_create_atomic function - quote camelCase column names
-- Date: 2025-11-12
...
BEGIN
  ...
  -- Insert sale with lowercase column names (Postgres converts unquoted to lowercase)
...
COMMENT ON FUNCTION public.sale_create_atomic IS 'Tạo hóa đơn và cập nhật tồn kho + giao dịch tiền mặt trong 1 transaction (atomic). Fixed column names with proper quotes.';
