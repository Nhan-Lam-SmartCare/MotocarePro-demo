-- Add refund support to work_orders table

-- Add refunded columns (using snake_case)
  ...
  IF v_order_row.partsUsed IS NOT NULL THEN
    ...
    LOOP
      ...
      IF v_quantity > 0 THEN
        ...
        SELECT COALESCE((stock->>v_order_row.branchId)::int, 0) INTO v_current_stock
