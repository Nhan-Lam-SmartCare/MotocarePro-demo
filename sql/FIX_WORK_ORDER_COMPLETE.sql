-- ============================================
-- FIX WORK ORDER CREATE - Complete Migration
-- Run this SQL in Supabase SQL Editor
-- ============================================

-- STEP 1: Add additionalServices column to work_orders table
DO $$ 
BEGIN
  IF NOT EXISTS (
  ...
  ELSE
    RAISE NOTICE 'ℹ️ additionalServices column already exists';
  END IF;
END $$;

-- STEP 2: Fix work_order_create_atomic function with quoted column names
...
BEGIN
  ...
  RAISE NOTICE 'ℹ️ You can now create work orders with parts';
END $$;
