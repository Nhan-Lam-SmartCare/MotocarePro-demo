-- Update sale_create_atomic to support quick services (no stock deduction)
-- Date: 2025-12-04
-- Quick services have partId starting with 'quick_service_' and skip stock operations
...
BEGIN
  ...
  FOR v_index IN 0..(v_items_count - 1) LOOP
    ...
    v_is_quick_service := (v_part_id LIKE 'quick_service_%');
  ...
  -- Cash transaction with lowercase column names
