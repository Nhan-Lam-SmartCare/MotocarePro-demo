-- Fix Cashbook Transaction Description to use readable Sale Code
-- Date: 2025-12-18
...
DECLARE
  ...
  v_sale_code TEXT; -- Variable to hold the generated sale_code
BEGIN
  ...
  VALUES (
    ...
    v_total, 
    NOW(), 
    'Thu từ hóa đơn ' || COALESCE(v_sale_code, p_sale_id), -- Use sale_code if available, fallback to ID
    p_branch_id, 
    p_payment_method, 
    COALESCE(v_sale_code, p_sale_id) -- Use sale_code as reference
  );
